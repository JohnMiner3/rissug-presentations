create or alter procedure MachineLearning.uspPredictCustomerRevenue
/**************************************************************************
*        Copyright (C) John Flannery
*        All rights reserved.
*
*        Name:        MachineLearning.uspPredictCustomerRevenue
*        Description: Returns a prediction as to potential new
*                     customer revenue.
*        Returns:     int
...
MachineLearning.uspPredictCustomerRevenue
